...
function build_ocean(config, grid;
    ...
    κ_skew = OMIPSimulations.resolve_hybrid_coefficient(κ_skew, hybrid_eddy_coefficients, :skew_coefficient)
    κ_symmetric = OMIPSimulations.resolve_hybrid_coefficient(κ_symmetric, hybrid_eddy_coefficients, :symmetric_coefficient)
